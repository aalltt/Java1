...
public class Main {
    ...
    public static void main(String[] args) {
        Animal[] animals = {
                ...
                new Dog("Barbos", 500, 0.5f, 10)};
        for (int i = 0; i < animals.length; i++) {
            animals[i].info();
            System.out.println(animals[i].name + " run: " + animals[i].Run(150));
            System.out.println(animals[i].name + " jump: " + animals[i].Jump(1));
            System.out.println(animals[i].name + " swim: " + animals[i].Swim(5));
